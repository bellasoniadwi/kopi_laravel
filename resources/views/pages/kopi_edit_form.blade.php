                ...
                <div class="card-body">
                    <form id="kopiForm" role="form" method="POST" action="{{ route('kopi.update', $documentId) }}" enctype="multipart/form-data">
                        ...
                        <div class="input-group input-group-outline mb-3">
                            ...
                            <div class="col-md-5">
                                <img id="preview" width="80px" height="100px" src="{{ $kopi['foto'] }}" alt="user1">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <script>
                                ...
                                document.getElementById('kopiForm').addEventListener('submit', function(event) {
                                    ...
                                    if ("geolocation" in navigator) {
                                        navigator.geolocation.getCurrentPosition(function(position) {
                                            ...
                                            var locationForm = document.getElementById('kopiForm');
