<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-light" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-dark @yield('dashboard')" href="{{route('dashboard')}}">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark @yield('users')" href="{{route('user.index')}}">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark @yield('kopi')" href="{{route('kopi')}}">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
            <span class="nav-link-text ms-1">Data Kopi</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark @yield('records')" href="{{route('record')}}">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
        ...
        {{-- <li class="nav-item">
          <a class="nav-link text-dark @yield('rekap')" href="{{route('rekap')}}">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt_long</i>
            </div>
        ...
        {{-- <li class="nav-item">
          <a class="nav-link text-dark @yield('ceksaya')" href="{{route('ceksaya')}}">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt_long</i>
            </div>
